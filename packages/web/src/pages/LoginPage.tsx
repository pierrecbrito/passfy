...
export const LoginPage: React.FC = () => {
  ...
  return (
    <div className="h-screen min-h-screen w-full bg-white grid grid-cols-1 lg:grid-cols-12 p-3 sm:p-4 gap-4 sm:gap-6 shadow-none border-none relative overflow-hidden select-none selection:bg-indigo-600 selection:text-white">
      ...
      <div className="lg:col-span-6 h-full relative rounded-[2rem] overflow-hidden min-h-[380px] flex flex-col justify-between p-8 sm:p-12 lg:p-14 select-none bg-gradient-to-br from-[#2b55f5] via-[#3b65f7] to-[#12289c]">
        ...
        <div className="relative z-10 space-y-4 pt-12 lg:pt-8">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-[44px] font-extrabold text-white leading-[1.18] tracking-tight drop-shadow-sm max-w-lg">
